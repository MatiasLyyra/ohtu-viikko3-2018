...
public class Stepdefs {
    ...
    public void user_is_tried_to_be_created(String username, String password) throws Throwable {
        selectRegister();
        registerWith(username, password, password);
    }
    ...
    @When("^invalid username \"([^\"]*)\" and valid password \"([^\"]*)\" and matching password confirmation are entered$")
    public void invalid_username_and_valid_password_and_confrimation_are_given(String username, String password) throws Throwable {
        registerWith(username, password, password);
    }
    ...
    @When("^valid username \"([^\"]*)\" and password \"([^\"]*)\" and password confirmation \"([^\"]*)\" are entered$")
    public void valid_username_and_password_and_password_confirmation_are_given(String username, String password, String passwordConfirmation) throws Throwable {
